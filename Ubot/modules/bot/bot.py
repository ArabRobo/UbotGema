...
async def on_plug_in_cb(_, callback_query: CallbackQuery):
    ...
    this_command += "@Dhilnihnge | sɪ ᴀʀᴀʙ-ᴜʙᴏᴛ"
    bttn = [
...
async def close(_, query: CallbackQuery):
    await query.message.reply_text(
       f"""<b>👋🏻 ʜᴀʟᴏ ɴɢᴇ sᴀʜᴀʙᴀᴛ sɪ ᴀʀᴀʙ-ᴜʙᴏᴛ .\n
💭 ꜱᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ ᴅɪ ʙᴏᴛ sɪ ᴀʀᴀʙ-ᴜʙᴏᴛ\n
👉🏻 ᴊɪᴋᴀ ɪɴɢɪɴ ᴍᴇᴍʙᴜᴀᴛ ᴜꜱᴇʀʙᴏᴛ ᴜʙᴏᴛ ᴀᴛᴀᴜ ʙᴏᴛ ʟᴀɪɴɴʏᴀ ᴛᴀɴᴘᴀ ʀɪʙᴇᴛ-ʀɪʙᴇᴛ ᴅᴇᴘʟᴏʏ.
ᴋᴀᴍᴜ ʙɪꜱᴀ ʜᴜʙᴜɴɢɪɴ ᴀᴅᴍɪɴ ᴅɪʙᴀᴡᴀʜ ɪɴɪ ᴜɴᴛᴜᴋ ᴍᴇᴍʙᴜᴀᴛ ʙᴏᴛ.\n
ᴊɪᴋᴀ ᴀɴᴅᴀ ʟɪᴍɪᴛ ᴅᴀɴ ᴛɪᴅᴀᴋ ʙɪsᴀ ᴍᴇɴɢʜᴜʙᴜɴɢɪ ᴀᴅᴍɪɴ ᴀɴᴅᴀ ʙɪsᴀ ᴍᴇʟᴀʟᴜɪ ʙᴏᴛ ʟɪᴍɪᴛ ᴏʀᴅᴇʀ ᴀʀᴀʙ sᴛᴏʀᴇ @SiArabLimitBot</b>""",
